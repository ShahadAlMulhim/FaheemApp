...
In this project beside work on the documentations and the **UI/UX design** of the application **my main role** in the implementation was **develop the android frontend part**, and this repository is only includes the android frontend part -the part I worked on- without the gaming and VR/AR development.
#
